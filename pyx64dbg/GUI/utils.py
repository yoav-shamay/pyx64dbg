...
async def prompt_for_expression(self, title: str, label: str, debugger_worker: DebuggerWorker, existing_value: str = "") -> Any:
    """
    ...
    """
    expr_str, ok = QInputDialog.getText(None, title, label, text=existing_value)
